...
from game_agent import heuristic_function1
from game_agent import heuristic_function2
from game_agent import heuristic_function3
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=heuristic_function3, **CUSTOM_ARGS), "Student-Heuristic3")]
    
#    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
#                   Agent(CustomPlayer(score_fn=heuristic_function1, **CUSTOM_ARGS), "Student-Heuristic1"),
#                   Agent(CustomPlayer(score_fn=heuristic_function2, **CUSTOM_ARGS), "Student-Heuristic2"),
#                   Agent(CustomPlayer(score_fn=heuristic_function3, **CUSTOM_ARGS), "Student-Heuristic3")]
